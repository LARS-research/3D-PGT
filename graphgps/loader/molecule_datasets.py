...
class MoleculeDataset(InMemoryDataset):
    def __init__(self, root, dataset='zinc250k', transform=None,
        ...
        if not empty:
            ...
            if dataset == 'bace' or dataset == 'bbbp' or dataset == 'tox21' or dataset == 'toxcast' or dataset == 'sider' or dataset == 'clintox' or dataset == 'muv' or dataset == 'hiv':
                self.data.y = (self.data.y + 1) / 2
                self.data.y = self.data.y.long()
            # if dataset == 'tox21':
            #     self.data.y = self.data.y.reshape(-1, 12)
